...
license: "BSD"
name: "spanner9", "spanner_1x8"
version: "1.0"
Code generated with Faust 2.40.7 (https://faust.grame.fr)
Compilation options: -a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -cn spanner9 -es 1 -mcd 16 -uim -double -ftz 0
------------------------------------------------------------ */

#ifndef  __spanner9_H__
#define  __spanner9_H__
...
class spanner9 : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -cn spanner9 -es 1 -mcd 16 -uim -double -ftz 0");
		m->declare("copyright", "Cecilia-labs");
		m->declare("filename", "spanner9.dsp");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("spanner9");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output1[i0] = FAUSTFLOAT(fTemp0 * std::pow(10.0, 0.20000000000000001 * fRec0[0] * (0.0 - 0.5 * (1.0 - std::cos(0.69813170079773179 - fTemp1)))));
			output2[i0] = FAUSTFLOAT(fTemp0 * std::pow(10.0, 0.20000000000000001 * fRec0[0] * (0.0 - 0.5 * (1.0 - std::cos(1.3962634015954636 - fTemp1)))));
			output3[i0] = FAUSTFLOAT(fTemp0 * std::pow(10.0, 0.20000000000000001 * fRec0[0] * (0.0 - 0.5 * (1.0 - std::cos(2.0943951023931953 - fTemp1)))));
			output4[i0] = FAUSTFLOAT(fTemp0 * std::pow(10.0, 0.20000000000000001 * fRec0[0] * (0.0 - 0.5 * (1.0 - std::cos(2.7925268031909272 - fTemp1)))));
			output5[i0] = FAUSTFLOAT(fTemp0 * std::pow(10.0, 0.20000000000000001 * fRec0[0] * (0.0 - 0.5 * (1.0 - std::cos(3.4906585039886591 - fTemp1)))));
			output6[i0] = FAUSTFLOAT(fTemp0 * std::pow(10.0, 0.20000000000000001 * fRec0[0] * (0.0 - 0.5 * (1.0 - std::cos(4.1887902047863905 - fTemp1)))));
			output7[i0] = FAUSTFLOAT(fTemp0 * std::pow(10.0, 0.20000000000000001 * fRec0[0] * (0.0 - 0.5 * (1.0 - std::cos(4.8869219055841224 - fTemp1)))));
			output8[i0] = FAUSTFLOAT(fTemp0 * std::pow(10.0, 0.20000000000000001 * fRec0[0] * (0.0 - 0.5 * (1.0 - std::cos(5.5850536063818543 - fTemp1)))));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
		}
	}
	...
	#define FAUST_FILE_NAME "spanner9.dsp"
	#define FAUST_CLASS_NAME "spanner9"
	#define FAUST_COMPILATION_OPIONS "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -cn spanner9 -es 1 -mcd 16 -uim -double -ftz 0"
	#define FAUST_INPUTS 1
	#define FAUST_OUTPUTS 9
 ...
 */
class spanner9_poly : public dsp_voice_group, public dsp_poly {
    ...
    private:
        ...
        {
            if (val == FAUSTFLOAT(1)) {
                static_cast<spanner9_poly*>(arg)->allNotesOff(true);
            }
        }
    ...
    public:
         ...
         * Constructor.
         *
         * @param dsp - the dsp to be used for one voice. Beware: spanner9_poly will use and finally delete the pointer.
        ...
        virtual spanner9_poly* clone()
        {
            return new spanner9_poly(fDSP->clone(), int(fVoiceTable.size()), fVoiceControl, fGroupControl);
        }
...
struct dsp_poly_factory : public dsp_factory {
    ...
    {
        dsp_poly* dsp_poly = new spanner9_poly(adaptDSP(fProcessFactory->createDSPInstance(), is_double), nvoices, control, group);
        if (fEffectFactory) {
...
void faust_allocate(t_faust* x, int nvoices)
{
    ...
    if (nvoices > 0) {
    ...
    #endif
        x->m_dsp = new spanner9_poly(new spanner9(), nvoices, true, true);
    #ifdef POLY2
        ...
        x->m_dsp = createSRAdapter<FAUSTFLOAT>(new spanner9(), DOWN_SAMPLING, UP_SAMPLING, FILTER_TYPE);
    }
