import {
  ...
  isObject,
  isString,
} from 'http://192.168.1.121:8081/osc-js-master/src/common/utils.js'

import Bundle from 'http://192.168.1.121:8081/osc-js-master/src/bundle.js'
import EventHandler from 'http://192.168.1.121:8081/osc-js-master/src/events.js'
import Message, { TypedMessage } from 'http://192.168.1.121:8081/osc-js-master/src/message.js'
import Packet from 'http://192.168.1.121:8081/osc-js-master/src/packet.js'

import DatagramPlugin from 'http://192.168.1.121:8081/osc-js-master/src/plugin/dgram.js'
import BridgePlugin from 'http://192.168.1.121:8081/osc-js-master/src/plugin/bridge.js'
import WebsocketClientPlugin from 'http://192.168.1.121:8081/osc-js-master/src/plugin/wsclient.js'
import WebsocketServerPlugin from 'http://192.168.1.121:8081/osc-js-master/src/plugin/wsserver.js'
